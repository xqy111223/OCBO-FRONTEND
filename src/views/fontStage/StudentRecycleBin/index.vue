...
<script>
/*
* Description studentRecycleBin
* Created By admin
* Created At 2019/9/18 14:09
*/
import { getStudentRecycleDataList, viewStudentInfo } from '@/api/fontStage/studentRecycleBin'
...
export default {
  ...
  methods: {
    ...
    async getList (newVal) {
      ...
      try {
        const result = await getStudentRecycleDataList(this.listQuery)
    ...
    async view (userId) {
      ...
      this.visible = true
      try {
        const result = await viewStudentInfo(userId)
