...
<!--        <select-region :area-id="queryData.areaId" :value.sync="queryData.areaId" :areaCode="areaCode" :filterable="true" clearble></select-region>-->
    ...
    <div class="middle">
      ...
      <div class="middle-button">
        <el-button type="custom" @click="exportTemplate()" round v-auth:student-export>导出</el-button>
      </div>
    </div>
    <div class="main">
      <el-table
...
<script>
/*
* Description studentManage
* Created By admin
* Created At 2019/9/18 14:07
*/
import { deleteStudent, exportExcel, getStudentDataList, viewStudentInfo } from '@/api/fontStage/studentManage'
...
export default {
  ...
  methods: {
    ...
    async getList (newVal) {
      ...
      try {
        const result = await getStudentDataList(this.listQuery)
    ...
    async view (userIds) {
      ...
      try {
        const result = await viewStudentInfo(userIds)
