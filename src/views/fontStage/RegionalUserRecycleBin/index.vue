<template>
  <div class="regionalUserRecycleBin">
    <div class="head mb15">
      <div class="head-item">
        <span>区域：</span>
...
<script>
/*
* Description regionalUserRecycleBin
* Created By admin
* Created At 2019/9/18 14:08
*/
import { getRegionalRecycleDataList, viewUserInfo } from '@/api/fontStage/regionalUserRecycleBin'
...
export default {
  ...
  components: { ViewDialog, SelectRegion },
  props: {},
  data () {
    return {
      total: 0, // 总数据数
  ...
  methods: {
    /**
     *   @description: 是否只显示本级用户
     *   @param arguments 描述
     *   @returns {}
     */
    showThisLevel () {
      if (this.listQuery.showThisLevel) {
        console.log(1)
      } else {
        console.log(2)
      }
    ...
    async getList (newVal) {
      ...
      try {
        const result = await getRegionalRecycleDataList(this.listQuery)
